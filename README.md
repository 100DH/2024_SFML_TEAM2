...
#### 안녕하세요 교수님. 2팀 조장 백대현입니다. 저희 팀의 과제는 저를 포함한 3명이서 과제를 진행하게 되었는데요, 조원이 4명임에도 불구하고 3명이서 과제를 하게 된 이유는 저희팀에 마지막으로 들어온 장현동씨께서 과제에 참여할 의사가 없다고 판단되어 3명이서 진행하였습니다. 최초 조를 구성했던 5월 28일 화요일 그래픽스 수업때, 저는 수업이 끝나는 순간까지 저희 조에 누가 들어왔는지 확인하기위해 새로고침을 눌러서 확인했습니다. 하지만, 그 때에는 분명히 저를 포함한 3명의 조원만 있었고, 수업이 끝난 후 카카오톡 방을 만들어서 조별과제를 진행하게 되었습니다. 팀을 구성한 이후로 lms를 확인하지 않아 뒤늦게 저희 팀에 합류한 장현동씨가 존재한다는 사실을 이 글을 적는 시점인 6월 1일 토요일에 확인하게 되었습니다. 팀장으로써 추가된 팀원을 확인하지 못한것은 제 불찰입니다. 하지만 화요일 팀 구성시간부터 현재 토요일 과제를 완성하고 제출하는 시점까지 뒤늦게 저희팀에 합류한 장현동씨는 조장인 제게 단 한번의 연락도 없었던 것으로 보아 팀 과제를 진행할 의사가 없다고 판단하였고, 아무 역할도 맡지않은 사람을 그저 조원이라는 이유만으로 이름을 넣어주기엔 같이 고생한 다른 팀원에게도 좋지 않을것이라고 생각하여 조장인 저의 판단으로 팀 과제에서 제외하게 되었습니다. 죄송합니다.
...
https://github.com/100DH/2024_SFML_TEAM2/assets/93199016/c3ae297e-de09-470d-9124-333090629942

![over](https://github.com/100DH/2024_SFML_TEAM2/assets/93199016/f4fb6def-a415-4304-bdea-2d3cb643b4ee)
...
### 기능 : W,A,S,D 를 이용하여 빨간색 캐릭터 조작 가능, 화살표 키를 이용하여 파란색 캐릭터 조작 가능, 벽이나 캐릭터에 공이 닿으면 튕겨나감, 골대에 공이 닿으면 점수를 카운트함. 먼저 3점 취득하는 사람이 승리, 각 플레이어의 캐릭터는 중앙의 선을 넘어갈 수 없도록 되어있음
